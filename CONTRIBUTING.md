...
Thank you for your interest in `loopback-ios-getting-started`, an open source project
administered by StrongLoop.

Contributing to `loopback-ios-getting-started` is easy. In a few simple steps:
