...
+ (instancetype)repository {
    AmmoModelRepository *repository = [self repositoryForClassName:@"ammo"];
...
- (IBAction)sendRequest:(id)sender {
    ...
    // 3. From that repository, create a new AmmoModel. We pass in an empty dictionary to defer setting
    //    any values.
